...
const getRegisterSchema = (t: (k: string) => string) =>
  z
    .object({
      fullName: z.string().min(2, { message: t('auth.errors.fullNameRequired') }),
...
export default function Register() {
  ...
  const onSubmit = async (values: RegisterValues) => {
    try {
      toast.loading(t('auth.register.creatingLoading'), { id: 'register' });
      ...
      toast.success(t('auth.register.createdSuccess'), { id: 'register' });
      ...
      <div className="w-full max-w-md space-y-10">
        ...
        <div className="space-y-6">
          ...
          <div className="relative flex items-center py-4">
            ...
            <span className="mx-4 shrink font-headline text-xs font-bold uppercase tracking-widest text-secondary">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="pt-4">
              <Button variant="primary" size="lg" type="submit" disabled={isSubmitting}>
                {isSubmitting ? t('auth.register.creating') : t('auth.register.join')}
              </Button>
            </div>
          </form>
        </div>
        ...
        <div className="pt-6 text-center">
          <p className="font-body text-secondary">
            ...
            <a
              className="ml-1 font-headline font-bold text-primary hover:underline"
              href="/auth/login"
            >
